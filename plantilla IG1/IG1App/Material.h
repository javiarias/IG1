...
public:
	...
	void setPewter() { ambient = { 0.10588, 0.058824, 0.113725, 1.0 }; diffuse = { 0.427451, 0.470588, 0.541176, 1.0 }; specular = { 0.3333, 0.3333, 0.521569, 1.0 }; expF = 9.84615; };
	void setGoggle() { ambient = { 0.25, 0.25, 0.25, 1.0 }; diffuse = { 0.4, 0.4, 0.4, 1.0 }; specular = { 0.774597, 0.774597, 0.774597, 1.0 }; expF = 76.8; };
	void setAAAA() { ambient = { 0.25, 0.25, 0.25, 1.0 }; diffuse = { 0.4, 0.4, 0.4, 1.0 }; specular = { 1, 1, 1, 1.0 }; expF = 100; };
